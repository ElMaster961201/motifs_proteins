...
cont = 1
t = True
ruta = "Resultados/Compu/Biologico/" + str(p[1]) # Ingresa el nombre de la carpeta donde se guardara el archico generado.
...
while t:
    if (os.path.exists(ruta + "/Experimento" + str(cont) + ".txt")):
        ...
        file2.write("Experimento v0.0."+ str(cont) + os.linesep)
        ...
        # file2.write("Torneo" + os.linesep)
        # file2.write("Ruleta" + os.linesep)
        # file2.write("Restos" + os.linesep)
        ...
        # file2.write("Multipunto" + os.linesep)
        # file2.write("Cruzamiento Uniforme" + os.linesep)
        
        file.write("Metodo de mutacion: ")
        file2.write("Mutacion:;")
        ###### Metodos de Mutacion. ######
        # file.write("Mutacion Estandar Biologica" + os.linesep)
        # file2.write("Mutacion Estandar Biologica" + os.linesep)
        ...
        # file2.write("Reemplazo Aleatorio" + os.linesep)
        # file2.write("Reemplazo de los Peor Adaptados" + os.linesep)
        # file2.write("Reemplazo de Adaptacion Similar" + os.linesep)
